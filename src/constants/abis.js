...
import testERC1155 from '../artifacts/contracts/TestERC1155.sol/TestERC1155.json';
import testToken from '../artifacts/contracts/TestToken.sol/TestToken.json';
import testNFT from '../artifacts/contracts/TestNFT.sol/TestNFT.json';
import deployedAddresses from './deployedAddresses.json'; // ✅ Frontend-safe static import

if (!deployedAddresses || typeof deployedAddresses !== "object") {
  throw new Error("🚨 deployedAddresses.json failed to load or is invalid.");
}

console.log("✅ Using deployedAddresses.json:", deployedAddresses);

export const TOKEN_ABI = testToken.abi;
export const NFT_ABI = testNFT.abi;
export const ERC1155_ABI = testERC1155.abi;
